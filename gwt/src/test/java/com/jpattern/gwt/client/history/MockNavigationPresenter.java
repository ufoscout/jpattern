 ...
 * 02/ago/2011
 */
public class MockNavigationPresenter extends APresenter<IView> {

	String viewEvent = "";
	
	public MockNavigationPresenter(IPresenterDefinition navigationEvent) {
	...
	static class View implements IView {
		...
		public void onNavigationEvent(String eventName) {
			...
			((MockNavigationPresenter) getPresenter()).viewEvent = eventName;			
		}
