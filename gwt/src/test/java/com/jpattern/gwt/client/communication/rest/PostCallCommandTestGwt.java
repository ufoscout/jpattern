...
import com.jpattern.gwt.client.communication.ServerCallPostCommand;
 ...
 * 12 Apr 2011
 */
public class PostCallCommandTestGwt extends BaseGwtTestCase {
	...
	public void testPostCallCommand() throws Exception {
		  Timer timer = new Timer() {
				...
				public void run() {
					...
					ACommand command = new ServerCallPostCommand<IWebResultResultObject,IResultObject>(dataInput, new StringBuffer(url), callResult ); 
