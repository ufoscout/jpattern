 ...
 * 08/ago/2011
 */
public class FixedSizeHistoryManager5Test extends BaseTest {
	...
	public void testHistoryManager2() throws Exception {
		
		MockMainNavigationEvent mainNavigationEvent = new MockMainNavigationEvent("");
		HasWidgets widgets = new NullHasWidgets();
		mainNavigationEvent.registerNavigationEvent(new NavEvent("event1"), widgets, new NullNavigationEventCallback());
		mainNavigationEvent.registerNavigationEvent(new NavEvent("event2"), widgets, new NullNavigationEventCallback());
		mainNavigationEvent.registerNavigationEvent(new NavEvent("event3"), widgets, new NullNavigationEventCallback());
		...
		assertEquals( "event1" , calledEventList.get(0));
		calledEventList.clear();
		SimplePresenter.createdPresenterList.clear();
		...
		System.out.println("createdPresenterList: ");
		for (IPresenter presetner : SimplePresenter.createdPresenterList) {
			System.out.println(presetner.getNavigationEvent().getName());
		}
		assertEquals( 1 , SimplePresenter.createdPresenterList.size() );
		assertEquals( "event3", SimplePresenter.createdPresenterList.get(0).getNavigationEvent().getName());
