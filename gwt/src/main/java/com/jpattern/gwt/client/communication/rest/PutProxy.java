...
public class PutProxy<T extends ICommandFacadeResult<?>,Z> extends AProxy<T> {
	...
	public PutProxy( ICallbackAction<T> callbackAction, IObjectSerializer<T> resultJsonBuilder, String url, IObjectSerializer<Z> sendJsonBuilder, Z data, IApplicationProvider provider) {
