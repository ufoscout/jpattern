...
public class GetProxy<T extends ICommandFacadeResult<?>> extends AProxy<T> {
	...
	public GetProxy( ICallbackAction<T> callbackAction, IObjectSerializer<T> jsonBuilder, String url, Map<String, String> keyValuesMap, IApplicationProvider provider) {
