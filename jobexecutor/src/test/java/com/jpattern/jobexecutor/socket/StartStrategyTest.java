 ...
 * 03/apr/2010
 */
public class StartStrategyTest extends BaseTest {
	...
	public void testStartStrategy() throws Exception {
		...
		ICommunicationClientStrategy communicationClientStrategy = new GenericConsoleComunicationClientStrategy( ICommandExecutorHandler.COMMAND_START);
