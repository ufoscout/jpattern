 ...
 * 29/gen/2011
 */
public class ChainElementUnBlocking3140 extends AChainElementUnblocking {
	...
	public ChainElementUnBlocking3140(int value, StringBuffer active, IChainElement chain) {
		super(chain);
		this.value = value;
		this.active = active;
	}
